      ...
      <div className="container mx-auto px-6 max-w-3xl">
        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Button size="lg" variant="outline" className="border-white/30 text-white hover:bg-white/10 hidden sm:inline-flex" asChild>
          ...
          <div className="flex justify-center gap-4 mt-6 sm:hidden">
            <Button size="icon" variant="outline" className="border-white/30 text-white hover:bg-white/10 h-12 w-12 rounded-full" asChild>
